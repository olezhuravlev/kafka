...
public class HelloWorldProducer2 {
    ...
    final static Logger LOGGER = LoggerFactory.getLogger(HelloWorldProducer2.class);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; ++i) {
            try (Producer<String, String> producer = new KafkaProducer<>(properties)) {
                ProducerRecord<String, String> producerRecord = new ProducerRecord<>(TOPIC, null, "Hello2_" + i);
